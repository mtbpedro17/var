...
export default function Dashboard() {
  const [mostrarPagarLicenca, setMostrarPagarLicenca] = useState(false);

  return (
    <div>
      <Sidebar2>
        <Container
          titulo={mostrarPagarLicenca
            ? "Pagamentos & licenças > Escolher & pagar Licença"
            : "Pagamentos & licenças"
          }
        ...
        >
          {mostrarPagarLicenca ? (
            ...
            <div className="w-[1180px] ml-3 mt-2">
              <PagarLicenca onVoltar={() => setMostrarPagarLicenca(false)} />
            </div>
          ) : (
            ...
            <>
              <div className="w-[1180px] ml-3 mt-2 flex flex-col gap-3">
                <LicencaAtiva
                  ...
                  onPagar={() => setMostrarPagarLicenca(true)}
                />
                <HistoricoPagamentos
