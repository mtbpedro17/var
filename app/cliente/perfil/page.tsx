    ...
    return(
        <div>
            <Sidebar2>
               ...
               <div className="w-[1180px]  ml-3 mt-2 flex  gap-3 mb-2">
               
                <div className="w-[400px] pb-3 border-[#050e4c] border rounded-2xl shadow-xl bg-[#040928]">
                    <PerfilCliente 
                    empresa="KITUXI TECH"
                 ...
                 <div className="w-[780px] pb-2 border-[#050e4c] border rounded-2xl shadow-xl bg-[#040928]">
                    <InformacoesEmpresa 
                    nome="Deloitte"
               ...
               <div className="w-[1180px]  ml-3 mt-1 flex gap-3 ">
               <div className="w-[400px] h-2.5 flex flex-col gap-3">
                        <Permissoes 
                        permissoes={[
                 ...
                 <div className="w-[780px] p-3 border-[#050e4c] border rounded-2xl shadow-xl bg-[#040928]">
